...
def overview(data, disk):
    ...
    print(f"{GRAY}{BOLD}    * {CYAN}EFI on {CYAN}{disk_data['efi']['block']}{CRESET}: {disk_data['efi']['size']}G{CRESET}")
    print(f"{GRAY}{BOLD}    * {CYAN}System on {CYAN}{disk_data['system']['block']}{CRESET}: {disk_data['system']['size']}G{CRESET}")
    print(f"{GRAY}{BOLD}    * {CYAN}User on {CYAN}{disk_data['user']['block']}{CRESET}: {disk_data['user']['size']}G{CRESET}")
    print(f"{GRAY}{BOLD}    * {CYAN}Swap on {CYAN}{disk_data['swap']['block']}{CRESET}: {disk_data['swap']['size']}G{CRESET}")
